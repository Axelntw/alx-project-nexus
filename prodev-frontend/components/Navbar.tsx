        ...
        <header className="sticky top-0 z-40 w-full border-b border-gray-200 bg-white/90 backdrop-blur">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
                ...
                <Link href="/" className="flex items-center gap-2" onClick={() => setMobileOpen(false)}>
                    <img src="/novamart-logo.svg" alt="NovaMart Logo" className="h-8 w-8 rounded-lg" />
                    <span className="text-lg font-bold tracking-tight text-emerald-700">NovaMart</span>
                </Link>
